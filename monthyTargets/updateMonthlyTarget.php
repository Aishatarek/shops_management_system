...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (isset($_POST['edit_submit'])) {
    ...
    $MonthlyTargets->updateMonthlyTarget($item_id, $monthly_target);
  }
}
?>
<!DOCTYPE html>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    ...
                    ?>
                        ...
                        <div class="form-group">
                          <label for="exampleInputarea">monthly Target</label>
                          <textarea class="form-control" name="monthly_target" id="exampleInputarea" placeholder="monthly target"><?php echo $monthlyTarget['monthly_target'] ?></textarea>
                        </div>
