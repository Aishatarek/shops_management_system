...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (isset($_POST['submit'])) {
    ...
    $MonthlyTargets->addMonthlyTarget($product, $store, $monthly_target);
  }
}
?>
<!DOCTYPE html>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" name="monthly_target" id="exampleInputarea" placeholder="monthly target">
