                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                if ($productt != 0 && $storee == 0) :
                                                    foreach ($MonthlyTargets->getData() as $monthlyTarget) :
                                                        if ($productt == $monthlyTarget['product']) :
                                                        ?>
                                                            <tr>
                                                                <td>
                                                                    <?php
                                                ...
                                                if ($productt != 0 && $storee != 0) :
                                                    foreach ($MonthlyTargets->getData() as $monthlyTarget) :
                                                        if ($productt == $monthlyTarget['product'] && $storee == $monthlyTarget['store']) :
                                                        ?>
                                                            <tr>
                                                                <td>
                                                                    <?php
