                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php
                                                        if ($user['role'] == "user"||$user['role'] == "spectator") {
                                                        ?>
                                                            <td>
                                                                <form method="post">
                                                            ...
                                                            <td>
                                                                <a href="updateUser.php?id=<?php echo $user['id']; ?>"><button class="btn btn-gradient-info btn-rounded "><i class="mdi mdi-pen menu-icon"></i></button></a>
                                                            </td>
                                                        <?php
                                                        } ?>
                                                    </tr>
