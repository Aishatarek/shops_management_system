                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form action="form.php" method="get" class="thesearch">
                                            <div>
                                            ...
                                            <div class="my-2">
                                                ...
                                                <select name="area" class="btn btn-outline-primary">
                                                    <option value="">All</option>
                                                    <?php
                                                    foreach ($Sales->getAreas() as $sales) {
                                                        if ($sales['area'] == $area) {
                                                    ?>
                                                            <option selected value="<?php echo $sales['area'] ?>"><?php echo $sales['area'] ?></option>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <option value="<?php echo $sales['area'] ?>"><?php echo $sales['area'] ?></option>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
                                            ...
                                            <div class="my-2">
                                                ...
                                                <select name="region" class="btn btn-outline-primary">
                                                    <option value="">All</option>
                                                    <?php
                                                    foreach ($Sales->getRegions() as $sales) {
                                                        if ($sales['region'] == $region) {
                                                    ?>
                                                            <option selected value="<?php echo $sales['region'] ?>"><?php echo $sales['region'] ?></option>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <option value="<?php echo $sales['region'] ?>"><?php echo $sales['region'] ?></option>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            foreach ($Sales->daily_target_sum2($date, $area, $region) as $sales1) :
                                                        ...
                                                        <td>
                                                            <?php
                                                            foreach ($Sales->daily_achieveit_sum2($date, $area, $region) as $sales2) :
                                                        ...
                                                        <td>
                                                            <?php
                                                            foreach ($Sales->mid_target_sum2_dash($date, $area, $region) as $sales3) :
                                                        ...
                                                        <td>
                                                            <?php
                                                            foreach ($Sales->mid_achieveit_sum2_dash($date, $area, $region) as $sales4) :
