                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <?php
                              foreach ($Sales->daily_target_sum() as $sales1) :
                            ...
                            <td>
                              <?php
                              foreach ($Sales->daily_achieveit_sum() as $sales2) :
                            ...
                            <td>
                              <?php
                              foreach ($Sales->mid_target_sum() as $sales3) :
                            ...
                            <td>
                              <?php
                              foreach ($Sales->mid_achieveit_sum() as $sales4) :
